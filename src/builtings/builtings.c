...
/*   Updated: 2023/06/08 11:06:30 by vzayas-s         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_checker(char	*str)
{
	if (!str)
		return (1);
	if (str && ft_strncmp(str, "pwd", 3) == 0 && ft_strlen(str) == 3)
		return (0);
	else if (str && ft_strncmp(str, "env", 3) == 0 && ft_strlen(str) == 3)
		return (0);
	else if (str && ft_strncmp(str, "echo", 4) == 0 && ft_strlen(str) == 4)
		return (0);
	else if (str && ft_strncmp(str, "exit", 4) == 0 && ft_strlen(str) == 4)
		return (0);
	else if (str && ft_strncmp(str, "cd", 2) == 0 && ft_strlen(str) == 2)
		return (0);
	else if (str && ft_strncmp(str, "export", 6) == 0 && ft_strlen(str) == 6)
		return (0);
	else if (str && ft_strncmp(str, "unset", 5) == 0 && ft_strlen(str) == 5)
		return (0);
	return (1);
}
